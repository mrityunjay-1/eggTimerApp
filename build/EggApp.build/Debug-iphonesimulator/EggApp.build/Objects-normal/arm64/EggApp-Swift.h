...
#ifndef EGGAPP_SWIFT_H
#define EGGAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EggApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6EggApp11AppDelegate")
...
SWIFT_CLASS("_TtC6EggApp13SceneDelegate")
...
SWIFT_CLASS("_TtC6EggApp14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified statusLabel;
@property (nonatomic, weak) IBOutlet UIProgressView * _Null_unspecified progrssBar;
- (void)viewDidLoad;
- (IBAction)eggPressed:(UIButton * _Nonnull)sender;
- (void)timeHandler;
